...
HD_PWD='E:/TFM/ANN_project/ANN_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_SW_standalone_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source design_SW_standalone_wrapper.tcl -notrace
