...
HD_PWD='E:/TFM/ANN_project/ANN_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_SW_standalone_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source design_SW_standalone_wrapper.tcl
