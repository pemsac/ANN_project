...
reset_run()
{
  files_to_remove=(ucli.key design_SWandHW_standalone_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc design_SWandHW_standalone_simv.daidir)
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.design_SWandHW_standalone xil_defaultlib.glbl -o design_SWandHW_standalone_simv
}
...
simulate()
{
  ...
  ./design_SWandHW_standalone_simv $opts -do simulate.do
}
# Script usage
usage()
{
