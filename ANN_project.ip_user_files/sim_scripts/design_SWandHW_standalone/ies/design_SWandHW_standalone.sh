...
#
# Filename    : design_SWandHW_standalone.sh
...
#
# Generated by Vivado on Thu Sep 01 14:49:48 +0200 2016
# IP Build 1491208 on Wed Feb 24 03:25:39 MST 2016 
#
# usage: design_SWandHW_standalone.sh [-help]
# usage: design_SWandHW_standalone.sh [-lib_map_path]
# usage: design_SWandHW_standalone.sh [-noclean_files]
# usage: design_SWandHW_standalone.sh [-reset_run]
#
...
# executing this script. Please type 'design_SWandHW_standalone.sh -help' for more information.
#
...
# Script info
echo -e "design_SWandHW_standalone.sh - Script generated by export_simulation (Vivado v2015.4.2 (64-bit)-id)\n"

# Script usage
usage()
{
  msg="Usage: design_SWandHW_standalone.sh [-help]\n\
Usage: design_SWandHW_standalone.sh [-lib_map_path]\n\
Usage: design_SWandHW_standalone.sh [-reset_run]\n\
Usage: design_SWandHW_standalone.sh [-noclean_files]\n\n\
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./design_SWandHW_standalone.sh -help\" for more information)\n"
  exit 1
fi
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./design_SWandHW_standalone.sh -help\" for more information)\n"
        exit 1
      fi
...
create_lib_mappings()
{
  libs=(xil_defaultlib axi_lite_ipif_v3_0_3 lib_cdc_v1_0_2 interrupt_control_v3_1_3 axi_gpio_v2_0_9 proc_sys_reset_v5_0_8 xbip_utils_v3_0_5 axi_utils_v2_0_1 xbip_pipe_v3_0_1 xbip_dsp48_wrapper_v3_0_4 xbip_dsp48_addsub_v3_0_1 xbip_dsp48_multadd_v3_0_1 xbip_bram18k_v3_0_1 mult_gen_v12_0_10 floating_point_v7_1_1 generic_baseblocks_v2_1_0 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_7 fifo_generator_v13_0_1 axi_data_fifo_v2_1_6 axi_crossbar_v2_1_8 lib_pkg_v1_0_2 lib_fifo_v1_0_4 lib_srl_fifo_v1_0_2 axi_datamover_v5_1_9 axi_sg_v4_1_2 axi_dma_v7_1_8 axis_infrastructure_v1_1_0 axis_data_fifo_v1_1_8 axi_protocol_converter_v2_1_7)
  file="cds.lib"
  dir="ies"
...
compile()
{
  ...
  ncvlog -work xil_defaultlib $opts_ver +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/axis_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" +incdir+"$ref_dir/../../../../ANN_project.srcs/sources_1/bd/design_SWandHW_standalone/ipshared/uc3m/feedforward_v1_4/drivers/feedforward_v1_4/src" \
    ...
    "$ref_dir/../../../bd/design_SWandHW_standalone/ip/design_SWandHW_standalone_processing_system7_0_0/sim/design_SWandHW_standalone_processing_system7_0_0.v" \
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ip/design_SWandHW_standalone_axi_gpio_0_0/sim/design_SWandHW_standalone_axi_gpio_0_0.vhd" \
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ip/design_SWandHW_standalone_rst_processing_system7_0_100M_0/sim/design_SWandHW_standalone_rst_processing_system7_0_100M_0.vhd" \

  ncvhdl -work xbip_utils_v3_0_5 $opts_vhd \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/xilinx.com/xbip_utils_v3_0/hdl/xbip_utils_v3_0_vh_rfs.vhd" \

  ncvhdl -work axi_utils_v2_0_1 $opts_vhd \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/xilinx.com/axi_utils_v2_0/hdl/axi_utils_v2_0_vh_rfs.vhd" \

  ncvhdl -work xbip_pipe_v3_0_1 $opts_vhd \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/xilinx.com/xbip_pipe_v3_0/hdl/xbip_pipe_v3_0_vh_rfs.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/xilinx.com/xbip_pipe_v3_0/hdl/xbip_pipe_v3_0.vhd" \

  ncvhdl -work xbip_dsp48_wrapper_v3_0_4 $opts_vhd \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/xilinx.com/xbip_dsp48_wrapper_v3_0/hdl/xbip_dsp48_wrapper_v3_0_vh_rfs.vhd" \

  ncvhdl -work xbip_dsp48_addsub_v3_0_1 $opts_vhd \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/xilinx.com/xbip_dsp48_addsub_v3_0/hdl/xbip_dsp48_addsub_v3_0_vh_rfs.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/xilinx.com/xbip_dsp48_addsub_v3_0/hdl/xbip_dsp48_addsub_v3_0.vhd" \

  ncvhdl -work xbip_dsp48_multadd_v3_0_1 $opts_vhd \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/xilinx.com/xbip_dsp48_multadd_v3_0/hdl/xbip_dsp48_multadd_v3_0_vh_rfs.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/xilinx.com/xbip_dsp48_multadd_v3_0/hdl/xbip_dsp48_multadd_v3_0.vhd" \

  ncvhdl -work xbip_bram18k_v3_0_1 $opts_vhd \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/xilinx.com/xbip_bram18k_v3_0/hdl/xbip_bram18k_v3_0_vh_rfs.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/xilinx.com/xbip_bram18k_v3_0/hdl/xbip_bram18k_v3_0.vhd" \

  ncvhdl -work mult_gen_v12_0_10 $opts_vhd \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/xilinx.com/mult_gen_v12_0/hdl/mult_gen_v12_0_vh_rfs.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/xilinx.com/mult_gen_v12_0/hdl/mult_gen_v12_0.vhd" \

  ncvhdl -work floating_point_v7_1_1 $opts_vhd \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/xilinx.com/floating_point_v7_1/hdl/floating_point_v7_1_vh_rfs.vhd" \

  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/uc3m/feedforward_v1_4/hdl/vhdl/feedforward.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/uc3m/feedforward_v1_4/hdl/vhdl/feedforward_AXILiteS_s_axi.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/uc3m/feedforward_v1_4/hdl/vhdl/feedforward_dadd_64ns_64ns_64_5_full_dsp.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/uc3m/feedforward_v1_4/hdl/vhdl/feedforward_ddiv_64ns_64ns_64_31.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/uc3m/feedforward_v1_4/hdl/vhdl/feedforward_dexp_64ns_64ns_64_18_full_dsp.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/uc3m/feedforward_v1_4/hdl/vhdl/feedforward_fadd_32ns_32ns_32_5_full_dsp.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/uc3m/feedforward_v1_4/hdl/vhdl/feedforward_fcmp_32ns_32ns_1_1.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/uc3m/feedforward_v1_4/hdl/vhdl/feedforward_fdiv_32ns_32ns_32_16.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/uc3m/feedforward_v1_4/hdl/vhdl/feedforward_fmul_32ns_32ns_32_4_max_dsp.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/uc3m/feedforward_v1_4/hdl/vhdl/feedforward_fpext_32ns_64_1.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/uc3m/feedforward_v1_4/hdl/vhdl/feedforward_fptrunc_64ns_32_1.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/uc3m/feedforward_v1_4/hdl/vhdl/feedforward_mul_7ns_31ns_38_3.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/uc3m/feedforward_v1_4/hdl/vhdl/feedforward_mul_7ns_32s_39_3.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/uc3m/feedforward_v1_4/hdl/vhdl/feedforward_mux_4to1_sel2_32_1.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/uc3m/feedforward_v1_4/hdl/vhdl/feedforward_p_uOut.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/uc3m/feedforward_v1_4/hdl/vhdl/feedforward_ST_WandB.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/uc3m/feedforward_v1_4/hdl/ip/feedforward_ap_dadd_3_full_dsp_64.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/uc3m/feedforward_v1_4/hdl/ip/feedforward_ap_ddiv_29_no_dsp_64.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/uc3m/feedforward_v1_4/hdl/ip/feedforward_ap_dexp_16_full_dsp_64.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/uc3m/feedforward_v1_4/hdl/ip/feedforward_ap_fadd_3_full_dsp_32.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/uc3m/feedforward_v1_4/hdl/ip/feedforward_ap_fcmp_0_no_dsp_32.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/uc3m/feedforward_v1_4/hdl/ip/feedforward_ap_fdiv_14_no_dsp_32.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/uc3m/feedforward_v1_4/hdl/ip/feedforward_ap_fmul_2_max_dsp_32.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/uc3m/feedforward_v1_4/hdl/ip/feedforward_ap_fpext_0_no_dsp_32.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/uc3m/feedforward_v1_4/hdl/ip/feedforward_ap_fptrunc_0_no_dsp_64.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ip/design_SWandHW_standalone_feedforward_0_0/sim/design_SWandHW_standalone_feedforward_0_0.vhd" \
  ...
  ncvlog -work xil_defaultlib $opts_ver +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/axis_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" +incdir+"$ref_dir/../../../../ANN_project.srcs/sources_1/bd/design_SWandHW_standalone/ipshared/uc3m/feedforward_v1_4/drivers/feedforward_v1_4/src" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ip/design_SWandHW_standalone_xbar_0/sim/design_SWandHW_standalone_xbar_0.v" \

  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ipshared/xilinx.com/xlconcat_v2_1/xlconcat.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ip/design_SWandHW_standalone_xlconcat_0_0/sim/design_SWandHW_standalone_xlconcat_0_0.vhd" \
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ip/design_SWandHW_standalone_axi_dma_1/sim/design_SWandHW_standalone_axi_dma_1.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ip/design_SWandHW_standalone_axi_dma_1_1/sim/design_SWandHW_standalone_axi_dma_1_1.vhd" \

  ncvlog -work xil_defaultlib $opts_ver +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/axis_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" +incdir+"$ref_dir/../../../../ANN_project.srcs/sources_1/bd/design_SWandHW_standalone/ipshared/uc3m/feedforward_v1_4/drivers/feedforward_v1_4/src" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ip/design_SWandHW_standalone_xbar_2/sim/design_SWandHW_standalone_xbar_2.v" \

  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ip/design_SWandHW_standalone_axi_dma_2_0/sim/design_SWandHW_standalone_axi_dma_2_0.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ip/design_SWandHW_standalone_axi_dma_3_0/sim/design_SWandHW_standalone_axi_dma_3_0.vhd" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ip/design_SWandHW_standalone_axi_dma_4_0/sim/design_SWandHW_standalone_axi_dma_4_0.vhd" \
  ...
  ncvlog -work xil_defaultlib $opts_ver +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/axis_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" +incdir+"$ref_dir/../../../../ANN_project.srcs/sources_1/bd/design_SWandHW_standalone/ipshared/uc3m/feedforward_v1_4/drivers/feedforward_v1_4/src" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ip/design_SWandHW_standalone_axis_data_fifo_0_0/sim/design_SWandHW_standalone_axis_data_fifo_0_0.v" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ip/design_SWandHW_standalone_axis_data_fifo_1_0/sim/design_SWandHW_standalone_axis_data_fifo_1_0.v" \
  ...
  ncvlog -work xil_defaultlib $opts_ver +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/axis_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" +incdir+"$ref_dir/../../../../ANN_project.srcs/sources_1/bd/design_SWandHW_standalone/ipshared/uc3m/feedforward_v1_4/drivers/feedforward_v1_4/src" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ip/design_SWandHW_standalone_auto_pc_0/sim/design_SWandHW_standalone_auto_pc_0.v" \
    "$ref_dir/../../../bd/design_SWandHW_standalone/ip/design_SWandHW_standalone_auto_pc_1/sim/design_SWandHW_standalone_auto_pc_1.v" \

  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/design_SWandHW_standalone/hdl/design_SWandHW_standalone.vhd" \
...
elaborate()
{
  ...
  libs="-libname unisims_ver -libname unimacro_ver -libname secureip -libname xil_defaultlib -libname axi_lite_ipif_v3_0_3 -libname lib_cdc_v1_0_2 -libname interrupt_control_v3_1_3 -libname axi_gpio_v2_0_9 -libname proc_sys_reset_v5_0_8 -libname xbip_utils_v3_0_5 -libname axi_utils_v2_0_1 -libname xbip_pipe_v3_0_1 -libname xbip_dsp48_wrapper_v3_0_4 -libname xbip_dsp48_addsub_v3_0_1 -libname xbip_dsp48_multadd_v3_0_1 -libname xbip_bram18k_v3_0_1 -libname mult_gen_v12_0_10 -libname floating_point_v7_1_1 -libname generic_baseblocks_v2_1_0 -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_7 -libname fifo_generator_v13_0_1 -libname axi_data_fifo_v2_1_6 -libname axi_crossbar_v2_1_8 -libname lib_pkg_v1_0_2 -libname lib_fifo_v1_0_4 -libname lib_srl_fifo_v1_0_2 -libname axi_datamover_v5_1_9 -libname axi_sg_v4_1_2 -libname axi_dma_v7_1_8 -libname axis_infrastructure_v1_1_0 -libname axis_data_fifo_v1_1_8 -libname axi_protocol_converter_v2_1_7"
  ncelab $opts xil_defaultlib.design_SWandHW_standalone xil_defaultlib.glbl $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.design_SWandHW_standalone -input simulate.do
}
# Script usage
usage()
{
