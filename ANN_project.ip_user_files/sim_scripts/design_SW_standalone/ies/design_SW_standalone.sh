...
elaborate()
{
  ...
  libs="-libname unisims_ver -libname unimacro_ver -libname secureip -libname xil_defaultlib -libname axi_lite_ipif_v3_0_3 -libname lib_cdc_v1_0_2 -libname interrupt_control_v3_1_3 -libname axi_gpio_v2_0_9 -libname proc_sys_reset_v5_0_8 -libname generic_baseblocks_v2_1_0 -libname fifo_generator_v13_0_1 -libname axi_data_fifo_v2_1_6 -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_7 -libname axi_protocol_converter_v2_1_7"
  ncelab $opts xil_defaultlib.design_SW_standalone xil_defaultlib.glbl $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.design_SW_standalone -input simulate.do
}
# Script usage
usage()
{
