...
#
# Filename    : design_SW_standalone.sh
...
#
# Generated by Vivado on Sat Aug 27 23:49:17 +0200 2016
# IP Build 1491208 on Wed Feb 24 03:25:39 MST 2016 
#
# usage: design_SW_standalone.sh [-help]
# usage: design_SW_standalone.sh [-lib_map_path]
# usage: design_SW_standalone.sh [-noclean_files]
# usage: design_SW_standalone.sh [-reset_run]
#
...
# executing this script. Please type 'design_SW_standalone.sh -help' for more information.
#
...
# Script info
echo -e "design_SW_standalone.sh - Script generated by export_simulation (Vivado v2015.4.2 (64-bit)-id)\n"

# Script usage
usage()
{
  msg="Usage: design_SW_standalone.sh [-help]\n\
Usage: design_SW_standalone.sh [-lib_map_path]\n\
Usage: design_SW_standalone.sh [-reset_run]\n\
Usage: design_SW_standalone.sh [-noclean_files]\n\n\
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./design_SW_standalone.sh -help\" for more information)\n"
  exit 1
fi
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./design_SW_standalone.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key design_SW_standalone_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc design_SW_standalone_simv.daidir)
...
create_lib_mappings()
{
  libs=(xil_defaultlib axi_lite_ipif_v3_0_3 lib_cdc_v1_0_2 interrupt_control_v3_1_3 axi_gpio_v2_0_9 proc_sys_reset_v5_0_8 generic_baseblocks_v2_1_0 fifo_generator_v13_0_1 axi_data_fifo_v2_1_6 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_7 axi_protocol_converter_v2_1_7)
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/design_SW_standalone/hdl/design_SW_standalone.vhd" \
  ...
  vlogan -work xil_defaultlib $opts_ver +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    ...
    "$ref_dir/../../../bd/design_SW_standalone/ip/design_SW_standalone_processing_system7_0_0/sim/design_SW_standalone_processing_system7_0_0.v" \
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/design_SW_standalone/ip/design_SW_standalone_axi_gpio_0_0/sim/design_SW_standalone_axi_gpio_0_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/design_SW_standalone/ip/design_SW_standalone_rst_processing_system7_0_100M_0/sim/design_SW_standalone_rst_processing_system7_0_100M_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vlogan -work xil_defaultlib $opts_ver +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/design_SW_standalone/ip/design_SW_standalone_auto_pc_0/sim/design_SW_standalone_auto_pc_0.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.design_SW_standalone xil_defaultlib.glbl -o design_SW_standalone_simv
}
...
simulate()
{
  ...
  ./design_SW_standalone_simv $opts -do simulate.do
}
# Script usage
usage()
{
