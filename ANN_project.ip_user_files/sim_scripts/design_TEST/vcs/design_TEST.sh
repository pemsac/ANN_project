...
compile()
{
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/design_TEST/ip/design_TEST_axi_dma_0_0/sim/design_TEST_axi_dma_0_0.vhd" \
    "$ref_dir/../../../bd/design_TEST/ip/design_TEST_axi_dma_1_0/sim/design_TEST_axi_dma_1_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/design_TEST/ip/design_TEST_rst_processing_system7_0_100M_0/sim/design_TEST_rst_processing_system7_0_100M_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vlogan -work xil_defaultlib $opts_ver +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/design_TEST/ip/design_TEST_auto_pc_0/sim/design_TEST_auto_pc_0.v" \
    "$ref_dir/../../../bd/design_TEST/ip/design_TEST_auto_pc_1/sim/design_TEST_auto_pc_1.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.design_TEST xil_defaultlib.glbl -o design_TEST_simv
}
...
simulate()
{
  ...
  ./design_TEST_simv $opts -do simulate.do
}
# Script usage
usage()
{
