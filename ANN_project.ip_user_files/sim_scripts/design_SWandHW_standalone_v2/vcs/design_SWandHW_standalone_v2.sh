...
reset_run()
{
  files_to_remove=(ucli.key design_SWandHW_standalone_v2_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc design_SWandHW_standalone_v2_simv.daidir)
...
compile()
{
  ...
  vlogan -work xil_defaultlib $opts_ver +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" +incdir+"$ref_dir/../../../../ANN_project.srcs/sources_1/bd/design_SWandHW_standalone_v2/ipshared/uc3m/ann_v2_1/drivers/ANN_v2_1/src" \
  ...
  vlogan -work generic_baseblocks_v2_1_0 $opts_ver +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" +incdir+"$ref_dir/../../../../ANN_project.srcs/sources_1/bd/design_SWandHW_standalone_v2/ipshared/uc3m/ann_v2_1/drivers/ANN_v2_1/src" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $opts_ver +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" +incdir+"$ref_dir/../../../../ANN_project.srcs/sources_1/bd/design_SWandHW_standalone_v2/ipshared/uc3m/ann_v2_1/drivers/ANN_v2_1/src" \
  ...
  vlogan -work axi_register_slice_v2_1_7 $opts_ver +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" +incdir+"$ref_dir/../../../../ANN_project.srcs/sources_1/bd/design_SWandHW_standalone_v2/ipshared/uc3m/ann_v2_1/drivers/ANN_v2_1/src" \
  ...
  vlogan -work axi_data_fifo_v2_1_6 $opts_ver +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" +incdir+"$ref_dir/../../../../ANN_project.srcs/sources_1/bd/design_SWandHW_standalone_v2/ipshared/uc3m/ann_v2_1/drivers/ANN_v2_1/src" \
  ...
  vlogan -work axi_crossbar_v2_1_8 $opts_ver +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" +incdir+"$ref_dir/../../../../ANN_project.srcs/sources_1/bd/design_SWandHW_standalone_v2/ipshared/uc3m/ann_v2_1/drivers/ANN_v2_1/src" \
  ...
  vlogan -work axi_protocol_converter_v2_1_7 $opts_ver +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" +incdir+"$ref_dir/../../../../ANN_project.srcs/sources_1/bd/design_SWandHW_standalone_v2/ipshared/uc3m/ann_v2_1/drivers/ANN_v2_1/src" \
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.design_SWandHW_standalone_v2 xil_defaultlib.glbl -o design_SWandHW_standalone_v2_simv
}
...
simulate()
{
  ...
  ./design_SWandHW_standalone_v2_simv $opts -do simulate.do
}
# Script usage
usage()
{
