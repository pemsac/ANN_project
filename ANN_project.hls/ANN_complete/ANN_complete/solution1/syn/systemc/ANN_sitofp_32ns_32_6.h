...
#ifndef __ANN_sitofp_32ns_32_6__HH__
#define __ANN_sitofp_32ns_32_6__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(ANN_sitofp_32ns_32_6) {
    ...
    SC_CTOR(ANN_sitofp_32ns_32_6):  ACMP_sitofp_U ("ACMP_sitofp_U") {
