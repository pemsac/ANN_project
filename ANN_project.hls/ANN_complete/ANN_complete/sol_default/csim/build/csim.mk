...
HLS_SOURCES = ../../../../Training.cpp ../../../../main.cpp ../../../../ANN.cpp
...
$(ObjDir)/Training.o: ../../../../Training.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../Training.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) -c -MMD    $(IFLAG) $(DFLAG)  $< -o $@ ; \

-include $(ObjDir)/Training.d
...
$(ObjDir)/ANN.o: ../../../../ANN.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../ANN.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) -c -MMD    $(IFLAG) $(DFLAG)  $< -o $@ ; \

-include $(ObjDir)/ANN.d
