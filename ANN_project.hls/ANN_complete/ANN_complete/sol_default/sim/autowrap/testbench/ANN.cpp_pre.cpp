# 1 "E:/TFM/ANN_project/ANN_project.hls/ANN_complete/ANN.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "E:/TFM/ANN_project/ANN_project.hls/ANN_complete/ANN.cpp"
# 22 "E:/TFM/ANN_project/ANN_project.hls/ANN_complete/ANN.cpp"
...
void ANN(const int config[4 +2],
 ...
 int netOut[35]);
# 23 "E:/TFM/ANN_project/ANN_project.hls/ANN_complete/ANN.cpp" 2
...
void ANN(const int config[4 +2],
  ...
  int netOut[35])
{
# 41 "E:/TFM/ANN_project/ANN_project.hls/ANN_complete/ANN.cpp"
  static double
  _WandB[4][35][35 +1],
  _uOut[4][35];
...
# 183 "E:/TFM/ANN_project/ANN_project.hls/ANN_complete/ANN.cpp"
      for(i=1; i<_numLayer; ++i)
 {
   for(j=0; j<_layerSize[i]; ++j)
     {
