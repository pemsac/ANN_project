...
#include "apatb_ANN.h"
#endif
#define ANN(...) AESL_ORIG_DUT_ANN(__VA_ARGS__)
#26 "E:/TFM/ANN_project/ANN_project.hls/ANN_complete/ANN.cpp"
void ANN(const int config[4 +2],
  const double WandB[4][35][35 +1],
  double uOut[4][35],
  const double netIn[35],
...
#220 "E:/TFM/ANN_project/ANN_project.hls/ANN_complete/ANN.cpp"
