...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "ANN.autotvin.dat"
	set constFileTvOut       "ANN.autotvout.dat"
	set constFileHdlTvIn     "ANN.autohdltvin.dat"
	set constFileHdlTvOut    "ANN.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
