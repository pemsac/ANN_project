...
void ANN(const int netConf[MAX_NUM_LAYER+2],
	 ...
	 int netOut[MAX_SIZE_LAYER])
{
   ...
   * Private variables:
   *
   * aqui se almacena lo que queramos en ram
   *
   *
   *
   ...
   *
   *
   * se le podria poner un unroll limitado al feedfordware con pipeline de loop-rewind
   */
  if(netConf[0]==0 || netConf[0]==2)
    {
      /*
