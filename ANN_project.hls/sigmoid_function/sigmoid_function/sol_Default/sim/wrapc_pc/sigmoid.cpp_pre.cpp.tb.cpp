...
#ifndef HLS_FASTSIM
#include "apatb_sigmoid.h"
#endif
#define sigmoid(...) AESL_ORIG_DUT_sigmoid(__VA_ARGS__)
#26 "E:/TFM/ANN_project/ANN_project.hls/sigmoid_function/files/sigmoid.cpp"
data_t sigmoid(const data_t num)
{
  return 1/(1+exp(-num));
}
...
#29 "E:/TFM/ANN_project/ANN_project.hls/sigmoid_function/files/sigmoid.cpp"
