...
HD_PWD='E:/TFM/ANN_project/ANN_project.hls/sigmoid_function/project/sol_Default/impl/vhdl/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sigmoid.vds -m64 -mode batch -messageDb vivado.pb -notrace -source sigmoid.tcl
