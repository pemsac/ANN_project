...
HD_PWD='E:/TFM/ANN_project/ANN_project.hls/sigmoid_function/project/sol_Default/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sigmoid.vdi -applog -m64 -messageDb vivado.pb -mode batch -source sigmoid.tcl -notrace
