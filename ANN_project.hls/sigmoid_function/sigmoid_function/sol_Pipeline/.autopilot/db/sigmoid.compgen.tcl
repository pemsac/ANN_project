...
set id 0
set name sigmoid_dadd_64ns_64ns_64_5_full_dsp
...
set id 1
set name sigmoid_ddiv_64ns_64ns_64_31
...
set id 2
set name sigmoid_dexp_64ns_64ns_64_18_full_dsp
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 3 \
			corename sigmoid_AXILiteS_axilite \
			name sigmoid_AXILiteS_s_axi \
			ports {$port_AXILiteS} \
			op interface \
		} "
	} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler sigmoid_AXILiteS_s_axi
}
