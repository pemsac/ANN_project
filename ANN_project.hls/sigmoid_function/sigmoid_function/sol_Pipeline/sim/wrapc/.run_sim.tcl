...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "sigmoid.autotvin.dat"
	set constFileTvOut       "sigmoid.autotvout.dat"
	set constFileHdlTvIn     "sigmoid.autohdltvin.dat"
	set constFileHdlTvOut    "sigmoid.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
